    ...
    <div class="card mb-0">
      <div class="card-body">
        <a href="/" class="brand-logo">
          <img src="homepage_files/logo-umi.png" class="brand-logo-img" alt="">
          <h2 style="padding-top: 1rem" class="brand-text text-primary ms-1">SIMBA - BPP</h2>
        </a>
